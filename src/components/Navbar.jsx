        ...
        <div className='h-20 px-8 z-50 bg-white top-0 sticky shadow-md'>
            <div className='flex items-center h-20 max-w-[1240px] mx-auto justify-between'>
                ...
                <ul className='hidden md:flex'>
                    <li className='p-4 font-bold cursor-pointer'>option1</li>

                    <li className='p-4 font-bold cursor-pointer'>option2</li>
                    <li className='p-4 font-bold cursor-pointer'>option3</li>
                    <li className='p-4 font-bold cursor-pointer'>option4</li>
                </ul>
